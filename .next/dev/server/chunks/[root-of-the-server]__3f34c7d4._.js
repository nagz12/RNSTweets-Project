...
const NEXT_PUBLIC_BASE_URL = ("TURBOPACK compile-time value", "http://localhost:3000") || "http://localhost:3000";
const IS_DEVELOPMENT = ("TURBOPACK compile-time value", "development") !== "production";
let transporter = null;
function getTransporter() {
    if (!transporter) {
        // In development, use a test account if email credentials are not provided
        if (IS_DEVELOPMENT && (!EMAIL_USER || !EMAIL_PASS)) {
            console.warn("[OTP] Development mode: Email credentials not configured. OTP codes will be logged to console instead of sent.");
            // Return a test transporter that logs instead of sending
            return {
                sendMail: async (options)=>{
                    console.log(`[OTP] Development email output:`, options);
                    return {
                        accepted: [
                            options.to
                        ]
...
async function createAndSendOtp(email, purpose) {
    ...
    `;
        // Log OTP in development mode where no email is configured
        if (IS_DEVELOPMENT && !EMAIL_USER) {
            console.log(`\n${"=".repeat(60)}`);
            console.log(`[OTP] ${purpose.toUpperCase()} OTP CODE FOR ${email}`);
        ...
        // Try to send email; if it fails and we're in development, fall back to logging the code
        try {
            await transporter.sendMail({
                from: EMAIL_USER || "noreply@rnstweets.local",
                to: email,
                subject,
                html
            });
            ...
            console.error(`[OTP] sendMail error:`, sendErr);
            if ("TURBOPACK compile-time truthy", 1) {
                console.warn("[OTP] sendMail failed in development — falling back to devCode response and logging");
                console.log(`\n${"=".repeat(60)}`);
                console.log(`[OTP] FALLBACK ${purpose.toUpperCase()} OTP CODE FOR ${email}`);
                console.log(`${"=".repeat(60)}`);
                console.log(`OTP Code: ${code}`);
                console.log(`Expires at: ${expiresAt.toISOString()}`);
                console.log(`${"=".repeat(60)}\n`);
                return {
                    success: true,
                    devCode: code,
                    error: "Email delivery failed (dev fallback used)"
                };
            }
        ...
        console.error(`[OTP] Error creating/sending OTP:`, error);
        return {
            success: false,
            error: "Failed to create or send OTP"
        };
    }
}
...
"[project]/OneDrive/Desktop/rnst-weets-social-platform/app/api/auth/login/start/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        // Verify password
        const isPasswordValid = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$node_modules$2f2e$pnpm$2f$bcryptjs$40$3$2e$0$2e$3$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, user.password);
        if (!isPasswordValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Send OTP
        const otpResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAndSendOtp"])(email.toLowerCase(), "login");
        if (!otpResult.success) {
            console.error("[LOGIN/START] OTP send failed:", otpResult.error);
            return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // In development mode without email configured, note it in response
        const isDev = ("TURBOPACK compile-time value", "development") !== "production" && !process.env.EMAIL_USER;
        return __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: isDev ? "Development mode: Check server console for OTP code" : "OTP sent to your email",
            email: email.toLowerCase(),
            ...otpResult.devCode ? {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f34c7d4._.js.map