...
const resolvers = {
    Query: {
        ...
        feed: async (_, __, context)=>{
            ...
            return tweets.map((t)=>({
                    ...
                    isLiked: Array.isArray(t.likes) ? t.likes.some((l)=>l.toString() === context.user.userId) : false,
                    isRetweeted: Array.isArray(t.retweets) ? t.retweets.some((r)=>r.toString() === context.user.userId) : false
                }));
        },
    ...
    Mutation: {
        ...
        createTweet: async (_, args, context)=>{
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(context.user.userId);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$empathy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureEmpathyDefaults"])(user);
            ...
            if (moderation.shouldBlock) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$empathy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyEmpathyViolation"])(user._id.toString(), penaltyPoints);
                ...
                const totalDemerits = updatedUser?.totalDemerits ?? updatedUser?.demeritPoints ?? 0;
                if (totalDemerits >= (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$ai$2d$moderation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSuspensionThreshold"])() || (updatedUser?.empathyScore ?? 0) <= 35) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].updateOne({
                        _id: user?._id
                    }, {
                        isSuspended: true
                ...
                throw new Error(`Tweet blocked due to ${moderation.reason}. Demerits: ${penaltyPoints}`);
            }
        ...
        likeTweet: async (_, args, context)=>{
            if (!context.user) throw new Error("Not authenticated");
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
            const actingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(context.user.userId);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$empathy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureEmpathyDefaults"])(actingUser);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4f6fa25._.js.map