...
"[project]/app/api/tweets/[id]/replies/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const replies = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Tweet$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tweet"].find({
            replyTo: tweetId
        }).populate("author", "id displayName username avatar").sort({
            createdAt: -1
        }).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__804655be._.js.map