...
"[project]/app/api/ai/wellness-dashboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        // Get user's empathy scores
        const empathyLogs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$EmpathyLog$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EmpathyLog"].find({
            user: user.userId
        }).sort({
            createdAt: -1
        }).limit(10).lean();
        const avgEmpathyScore = empathyLogs.length > 0 ? empathyLogs.reduce((sum, log)=>sum + log.empathyScore, 0) / empathyLogs.length : 0;
        // Get demerit history
        const demerits = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Demerit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Demerit"].find({
            user: user.userId
        }).sort({
            createdAt: -1
        }).limit(5).lean();
        const totalDemerits = demerits.reduce((sum, d)=>sum + d.points, 0);
        // Check if user is involved in any bullying patterns
        const asOffender = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BullyingPattern$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BullyingPattern"].find({
            offender: user.userId,
            isResolved: false
        }).populate("victim", "username displayName").lean();
        const asVictim = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$BullyingPattern$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BullyingPattern"].find({
            victim: user.userId,
            isResolved: false
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2af5c01._.js.map