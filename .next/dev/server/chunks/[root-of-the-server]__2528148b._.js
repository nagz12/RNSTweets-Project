...
"[project]/OneDrive/Desktop/rnst-weets-social-platform/app/api/tweets/explore/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const formattedTweets = validTweets.map((t)=>({
                ...
                isLiked: userId && Array.isArray(t.likes) ? t.likes.some((l)=>l.toString() === userId) : false,
                isRetweeted: userId && Array.isArray(t.retweets) ? t.retweets.some((r)=>r.toString() === userId) : false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2528148b._.js.map