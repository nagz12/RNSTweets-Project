...
"[project]/OneDrive/Desktop/rnst-weets-social-platform/app/api/tweets/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        }).select("username displayName bio profilePictureUrl bannerUrl isVerified followers following").limit(10).lean();
        const currentUser = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$rnst$2d$weets$2d$social$2d$platform$2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(decoded.userId).select("following").lean();
        const followingIds = currentUser?.following?.map((id)=>id.toString()) || [];
        const validTweets = tweets.filter((tweet)=>tweet.author && !tweet.author.isSuspended);
        const tweetsWithLikeStatus = validTweets.map((tweet)=>({
                ...
                isLiked: tweet.likes?.some((likeId)=>likeId.toString() === decoded.userId),
                isRetweeted: tweet.retweets?.some((retweetId)=>retweetId.toString() === decoded.userId),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a4d2dd56._.js.map