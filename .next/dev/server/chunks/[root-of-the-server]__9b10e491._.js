...
"[project]/app/api/tweets/explore/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const formattedTweets = tweets.map((t)=>({
                ...
                isLiked: userId && t.likes.some((l)=>l.toString() === userId),
                isRetweeted: userId && t.retweets.some((r)=>r.toString() === userId)
            }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b10e491._.js.map